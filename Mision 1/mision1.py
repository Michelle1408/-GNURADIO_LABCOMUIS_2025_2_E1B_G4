...
class mision1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "mision1")
        ...
        self._grx_range = qtgui.Range(0, 30, 1, 30, 200)
        self._grx_win = qtgui.RangeWidget(self._grx_range, self.set_grx, "'grx'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._grx_win)
        self._fc_range = qtgui.Range(50e6, 2200e6, 1e6, 50e6, 200)
...
def main(top_block_cls=mision1, options=None):
