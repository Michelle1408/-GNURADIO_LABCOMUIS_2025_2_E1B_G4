...
class FMStereo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "FMStereo")
        ...
        self.uhd_usrp_sink_0.set_samp_rate((int(samp_rate*4)))
        self.uhd_usrp_sink_0.set_time_now(uhd.time_spec(time.time()), uhd.ALL_MBOARDS)

        self.uhd_usrp_sink_0.set_center_freq(107e6, 0)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/estudiante/Descargas/audio de prueba.wav', True)
        self.blocks_throttle2_0_0_0 = blocks.throttle( gr.sizeof_float*1, 48000, True, 0 if "auto" == "auto" else max( int(float(0.1) * 48000) if "auto" == "time" else int(0.1), 1) )
        ...
        self.analog_wfm_tx_0 = analog.wfm_tx(
        	...
        	quad_rate=(4*int(samp_rate)),
        	tau=(75e-6),
        	max_dev=75e3,
        	fh=(-1.0),
        )
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 38000, 0.1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 19000, 0.01, 0, 0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_throttle2_0_0, 0))
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.analog_wfm_tx_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.blocks_add_xx_1, 1))
        self.connect((self.blocks_throttle2_0_0_0, 0), (self.rational_resampler_xxx_0, 0))
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_throttle2_0_0_0, 0))
        self.connect((self.blocks_wavfile_source_0, 1), (self.rational_resampler_xxx_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 15000, 1000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 15000, 1000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, (self.samp_rate*4), 1e5, 20e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_freq_sink_x_0_0_0_0.set_frequency_range(0, (self.samp_rate*4))
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate)
        self.uhd_usrp_sink_0.set_samp_rate((int(self.samp_rate*4)))




def main(top_block_cls=FMStereo, options=None):
