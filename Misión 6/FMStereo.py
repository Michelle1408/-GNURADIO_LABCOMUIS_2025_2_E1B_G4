...
class FMStereo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0.set_samp_rate(int(samp_rate))
        ...
        self.connect((self.analog_wfm_tx_0, 0), (self.qtgui_freq_sink_x_0_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.uhd_usrp_sink_0.set_samp_rate(int(self.samp_rate))
